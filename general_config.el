...
"oe"   '(:ignore t :which-key "elisp")
"oee"   '(eval-region :which-key "eval-region")
"oeE"   '(eval-buffer :which-key "eval-buffer")
"oef"   '(elisp-format-region :which-key "elisp-format-region")
"oeF"   '(elisp-format-file :which-key "elisp-format-file")
"oeb"   '(elisp-format-buffer :which-key "elisp-format-buffer")
...
"sj"  '(agamacs/helm-jump-in-buffer :which-key "helm-jump-in-buffer")
...
"sgb" '(agamacs/helm-buffers-do-grep :which-key "helm-buffers-do-grep")
"sgB" '(agamacs/helm-buffers-do-grep-region-or-symbol :which-key "helm-buffers-do-grep-reg-or-sym")
"sgf" '(agamacs/helm-files-do-grep :which-key "helm-files-do-grep")
"sgF" '(agamacs/helm-files-do-grep-region-or-symbol :which-key "helm-files-do-grep-reg-or-sym")
"sgg" '(agamacs/helm-file-do-grep :which-key "helm-file-do-grep")
"sgG" '(agamacs/helm-file-do-grep-region-or-symbol :which-key "helm-file-do-grep-reg-or-sym")
...
(general-define-key
   ...
   "j"  '(agamacs/helm-jump-in-buffer :which-key "helm-jump-in-buffer")
...
(general-define-key
 ...
 :prefix ","
 ","  '(cperl-perldoc-at-point t :which-key "perldoc-at-point")
 "o"  '(cperl-perldoc t :which-key "cperl-perldoc")
 "d"  '(cperl-db :which-key "debugger")
 "f"  '(flycheck-mode :which-key "flycheck-mode")
