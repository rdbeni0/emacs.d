;;; cfg-op-projectile.el --- configfuration for projectile -*- lexical-binding: t -*-
;;; Commentary:
;;
...
;; additional defuns for projectile (taken from spacemacs):
...
(provide 'cfg-op-projectile)
;;; cfg-op-projectile.el ends here
