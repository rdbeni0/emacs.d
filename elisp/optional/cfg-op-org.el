...
;; if true, load additional variables for org
...
(if (file-readable-p (expand-file-name "data/local/lo-org.el" user-emacs-directory))
    (require 'lo-org)
  (message "WARNING! File data/local/lo-org.el inside your emacs.d is not readable (or not exist)! Please create it and add correct op-org options!"))
