;;; cfg-op-tabbar.el --- tabbar in Emacs -*- lexical-binding: t -*-
;;; Commentary:
;;
;; tab-bar - since emacs 27 version (new version of tabs): (tab-bar-mode 1)
;; Configuration for various options for tabbar (tabbar is old legacy plugin).
;; Introduction:
...
(use-package tabbar
  ...
  (require 'cfg-gen-op-tabbar)
  ;; end of use-package....
  )

(provide 'cfg-op-tabbar)
;;; cfg-op-tabbar.el ends here
