;;; cfg-op-doom-themes.el --- configure doom themes -*- lexical-binding: t -*-
;;; Commentary:
;;
;; Setup for (black/dark) doom themes.
;;
;;; Code:
...
(provide 'cfg-op-doom-themes)
;;; cfg-op-doom-themes.el ends here
