...
(general-define-key
 ...
 "/h" '(ggtags-find-reference :which-key "ggt-find-reference")
 ...
 "/n" '(ggtags-find-definition :which-key "ggt-find-definition")
...
(general-define-key
 ...
 "g/h" '(ggtags-find-reference :which-key "ggt-find-reference")
 ...
 "g/n" '(ggtags-find-definition :which-key "ggt-find-definition")
...
(general-define-key
 ...
 "s/h" '(ggtags-find-reference :which-key "ggt-find-reference")
 ...
 "s/n" '(ggtags-find-definition :which-key "ggt-find-definition")
...
(provide 'cfg-gen-op-ggtags)
;;; cfg-gen-op-ggtags.el ends here
