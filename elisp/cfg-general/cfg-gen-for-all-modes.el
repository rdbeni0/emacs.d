...
(general-define-key
 ...
 "fe"  '(revert-buffer :which-key "revert-refresh-buffer")
 ...
 "s/"  '(vc-git-grep :which-key "vc-git-grep")
 "s'"  '(vc-git-grep :which-key "vc-git-grep")
 ...
 "sg/" '(vc-git-grep :which-key "vc-git-grep")
 "sg'" '(vc-git-grep :which-key "vc-git-grep")
 ...
 "p/"  '(vc-git-grep :which-key "vc-git-grep")
