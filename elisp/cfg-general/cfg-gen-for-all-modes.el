...
(general-define-key
 ...
 "fe"  '(revert-buffer :which-key "revert-buffer")
 ...
 "p/"  '(cfg/helm-git-grep-at-point :which-key "helm-git-grep-at-point")
 "p'"  '(cfg/helm-git-grep :which-key "helm-git-grep")
 "py"  '(helm-browse-project :which-key "helm-ls-git")
 "pY"  '(helm-projects-history :which-key "helm-ls-git-history")
