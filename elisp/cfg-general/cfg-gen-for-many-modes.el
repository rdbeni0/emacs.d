...
(setq list-gen-mode-conf-mode '(conf-mode conf-unix-mode conf-space-mode))
(setq list-gen-mode-conf-mode-map '(conf-mode-map conf-unix-mode-map conf-space-mode-map))
