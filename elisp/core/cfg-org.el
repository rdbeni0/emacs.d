...
(use-package org
  ...
  ;; please create correct "org.el" file inside ~/.emacs.d/local_data/org.el (or other emacs dir)
  ;; Please add below variables inside this file:
  ;; (setq org-agenda-files ...

  (if (file-readable-p (expand-file-name "local_data/org.el" user-emacs-directory))
      (load (expand-file-name "local_data/org.el" user-emacs-directory)) ; if true, load additional variables for org-mode
					; if false, then message with "WARNING" will appear during initialization of org-mode:
    (message "WARNING! File local_data/org.el inside your emacs.d is not readable (or not exist)! Please create it and add correct org-mode options!"))
